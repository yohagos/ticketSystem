...
func TestRegistrationGETHandler(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			RegistrationGETHandler(tt.args.w, tt.args.r)
		})
	}
}
...
func TestRegistrationPOSTHandler(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			RegistrationPOSTHandler(tt.args.w, tt.args.r)
		})
	}
}
...
func TestLogoutGETHandler(t *testing.T) {
	type args struct {
		w http.ResponseWriter
		r *http.Request
	}
...
func TestProfileGETHandler(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ProfileGETHandler(tt.args.w, tt.args.r)
		})
	}
}
